...
function Sidebar() {
  ...
  return (
    <aside className="sidebar-shell relative z-10 flex w-full shrink-0 flex-col border-b border-white/10 bg-[#111216]/90 backdrop-blur-xl md:h-dvh md:w-[244px] md:border-r md:border-b-0 lg:w-[256px]">
      <div className="flex items-center justify-between border-b border-white/8 px-5 py-4 md:px-5 md:py-7">
        ...
        <button type="button" onClick={signOut} className="rounded-full border border-white/20 bg-white/5 px-3 py-1.5 text-[11px] text-muted-foreground hover:text-foreground md:hidden">Sign out</button>
      </div>
